...
export default function Login() {
  return (
     <main className="bg-bege h-screen px-60 justify-center flex items-center">
        <div className="flex flex-row border-3 border-mescuro rounded-2xl w-full">
            ...
            <div className="flex flex-col items-center justify-start gap-5 text-mescuro w-full px-6">
                ...
                <div className="flex flex-col gap-2 w-full font-texto font-semibold">
                    <div className="relative flex flex-row items-center  w-full">
                        ...
                        <input className=" w-full focus:outline-none text-sm rounded-lg py-2 text-mescuro pl-8 border-mescuro border-2 pr-28 pl-2" placeholder="Nome"/>
                    </div>
                    <div className="relative flex flex-row items-center w-full">
                        <i className="absolute left-3 bi bi-envelope-heart"></i>
                        <input className="w-full focus:outline-none text-sm rounded-lg py-2 text-mescuro pl-8 border-mescuro border-2 pr-28 pl-2" placeholder="Email"/>
                    </div>                
                    <div className="relative flex flex-row items-center w-full">
                        <i className="absolute left-3 bi bi-shield-lock"></i>
                        <input className="w-full focus:outline-none text-sm rounded-lg py-2 text-mescuro pl-8 border-mescuro border-2 pr-28 pl-2" placeholder="Senha"/>
                    </div>                
                </div>
